...
@interface OPPAfterPayPaymentParams : OPPPaymentParams <NSCopying>
/// :nodoc:
...
@interface OPPApplePayPaymentParams (SWIFT_EXTENSION(OPPWAMobile))
- (NSDictionary * _Nonnull)dictionaryForExecutingTransaction SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface OPPBankAccountPaymentParams : OPPPaymentParams <NSCopying>
...
@interface OPPBlikPaymentParams : OPPPaymentParams <NSCopying>
...
@interface OPPCardPaymentParams : OPPBaseCardPaymentParams <NSCopying>
...
@interface OPPCashAppPayPaymentParams : OPPPaymentParams <NSCopying>
...
@interface OPPChinaUnionPayPaymentParams : OPPPaymentParams <NSCopying>
...
@interface OPPClearPayPaymentParams : OPPPaymentParams <NSCopying>
/// :nodoc:
- (nullable instancetype)initWithCheckoutID:(NSString * _Nonnull)checkoutID paymentBrand:(NSString * _Nullable)paymentBrand error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("", "initWithCheckoutID:error:");
...
typedef SWIFT_ENUM(NSInteger, OPPFeatureSwitch, open) {
  ...
  OPPFeatureSwitchSwiftCheckoutProvider = 2,
  OPPFeatureSwitchThreeDSOOBSupported = 3,
  OPPFeatureSwitchKlarnaWebFlowTest = 4,
};
...
SWIFT_CLASS("_TtC11OPPWAMobile23OPPIkanoOiPaymentParams")
@interface OPPIkanoOiPaymentParams : OPPPaymentParams <NSCopying>
/// National identifier of the account.
@property (nonatomic, readonly, copy) NSString * _Nonnull nationalIdentifier;
/// :nodoc:
- (nullable instancetype)initWithCheckoutID:(NSString * _Nonnull)checkoutID paymentBrand:(NSString * _Nullable)paymentBrand error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("", "initWithCheckoutID:paymentBrand:nationalIdentifier:error:");
...
+ (OPPIkanoOiPaymentParams * _Nullable)ikanoOiPaymentParamsWithCheckoutID:(NSString * _Nonnull)checkoutID paymentBrand:(NSString * _Nullable)paymentBrand nationalIdentifier:(NSString * _Nonnull)nationalIdentifier error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
/// Creates an object representing an Ikano transaction.
/// \param checkoutID The checkout ID of the transaction. Must be not <code>nil</code> or empty.
///
/// \param paymentBrand IKANOOI_SE, IKANOOI_NO or IKANOOI_FI is expected.
...
/// returns:
/// An object representing an Ikano transaction.
- (nullable instancetype)initWithCheckoutID:(NSString * _Nonnull)checkoutID paymentBrand:(NSString * _Nullable)paymentBrand nationalIdentifier:(NSString * _Nonnull)nationalIdentifier error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
...
///
/// returns:
/// <code>true</code> if the national identifier value is valid.
+ (BOOL)isNationalIdentifierValid:(NSString * _Nonnull)nationalIdentifier forPaymentBrand:(NSString * _Nullable)paymentBrand SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (NSDictionary * _Nonnull)dictionaryForExecutingTransaction SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
...
@interface OPPIkanoPrivateLabelVAPaymentParams : OPPPaymentParams <NSCopying>
/// The account number.
...
@interface OPPInicisPaymentParams : OPPPaymentParams <NSCopying>
/// :nodoc:
- (nullable instancetype)initWithCheckoutID:(NSString * _Nonnull)checkoutID paymentBrand:(NSString * _Nullable)paymentBrand error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("", "initWithCheckoutID:error:");
...
@interface OPPKlarnaInlinePaymentParams : OPPPaymentParams <NSCopying>
...
@interface OPPMBWayPaymentParams : OPPPaymentParams <NSCopying>
...
@interface OPPRatePayPaymentParams : OPPPaymentParams <NSCopying>
/// :nodoc:
...
@interface OPPSTCPayPaymentParams : OPPPaymentParams <NSCopying>
...
@interface OPPTokenPaymentParams : OPPBaseCardPaymentParams <NSCopying>
...
SWIFT_CLASS("_TtC11OPPWAMobile15OPPYooKassaInfo")
@interface OPPYooKassaInfo : NSObject
/// Status of YooKassa payment.
@property (nonatomic, readonly) enum OPPYooKassaStatus status;
/// The URL string to redirect the user to confirm payment.
@property (nonatomic, readonly, copy) NSString * _Nullable confirmationUrl;
...
///
/// returns:
/// Returns an <code>OPPYooKassaInfo</code> object.
- (nullable instancetype)initWithStatus:(enum OPPYooKassaStatus)status confirmationUrl:(NSString * _Nullable)confirmationUrl callbackUrl:(NSString * _Nullable)callbackUrl OBJC_DESIGNATED_INITIALIZER;
/// Creates YooKassa info object with the provided status, confirmation and callback urls.
/// \param status Status of YooKassa payment.
///
/// \param confirmationUrl The URL string to redirect the user to confirm payment.
...
/// returns:
/// Returns an <code>OPPYooKassaInfo</code> object.
+ (OPPYooKassaInfo * _Nullable)yooKassaInfoWith:(enum OPPYooKassaStatus)status confirmationUrl:(NSString * _Nullable)confirmationUrl callbackUrl:(NSString * _Nullable)callbackUrl SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
+ (enum OPPYooKassaStatus)statusFrom:(NSString * _Nonnull)statusString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Enumeration of possible statuses of YooKassa payment.
typedef SWIFT_ENUM(NSInteger, OPPYooKassaStatus, open) {
/// Payment is successfully completed.
  OPPYooKassaStatusSucceeded = 0,
/// Payment is created, waiting for user confirmation.
  OPPYooKassaStatusPending = 1,
/// Payment is made, funds are authorized and waiting for capture.
  OPPYooKassaStatusWaitingForCapture = 2,
/// Payment is canceled.
  OPPYooKassaStatusCanceled = 3,
/// Status is not defined.
  OPPYooKassaStatusUndefined = 4,
};
